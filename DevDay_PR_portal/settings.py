...
ROOT_URLCONF = "DevDay_PR_portal.urls"
...
WSGI_APPLICATION = "DevDay_PR_portal.wsgi.application"
...
AUTH_USER_MODEL = "portal.User"  # Telling Django, who is the user in our system
